...
/**
 * The {@code User} class represents a user with attributes such as name, email, birthdate, gender, and CPF,
 * and overrides the {@code equals} and {@code hashCode} methods to compare and hash based on the CPF attribute.
 */
@NoArgsConstructor
@AllArgsConstructor
@Getter
...
public class User {
    ...
    /**
     * This is an implementation of the {@code equals} method in Java that checks if two User objects have the same CPF (a unique
     * identifier for individuals in Brazil).
     *
     * @param o The parameter {@code o} is an object of type {@code Object}, which is the superclass of all classes in Java. It is used
     *          to compare the equality of two objects of the {@code User} class.
    ...
    /**
     * This function overrides the default {@code hashCode()} method to return the hash code of the object's cpf attribute.
     *
